...
class ImagePreset:
    ...
    def set_custom_uc_preset(self, model: ImageModel, bad_tag: str) -> None:
        """
        set custom uc_preset value

        :param model:Novel image model class
        :param bad_tag:Novel bad tag
        :return: None
        """
        self._UC_Presets[model][UCPreset.Preset_Custom] = bad_tag
